document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- 5. EMAILJS CONTACT FORM LOGIC (FIXED FOR v4) ---
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            // Pass the public key directly inside the sendForm function
            // Pass the actual 'contactForm' element instead of 'this'
            emailjs.sendForm('service_172d0i5', 'template_3y1zzwl', contactForm, {
                publicKey: 'S2p2mt3IfnLxunPQH',
            })
            .then(() => {
                btnText.innerText = "MESSAGE SENT!";
                btnIcon.classList.remove('animate-spin');
                btnIcon.innerHTML = `<path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path>`; 
